...
class GroupRow extends DataClass implements Insertable<GroupRow> {
  ...
  GroupRow copyWith({String? id, String? name, int? position}) => GroupRow(
    id: id ?? this.id,
    name: name ?? this.name,
...
class $TasksTable extends Tasks with TableInfo<$TasksTable, TaskRow> {
  ...
  @override
  late final GeneratedColumn<String> statusBeforeTrash =
...
class TaskRow extends DataClass implements Insertable<TaskRow> {
  ...
  final String? statusBeforeTrash;
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (!nullToAbsent || statusBeforeTrash != null) {
      map['status_before_trash'] = Variable<String>(statusBeforeTrash);
    }
  ...
  factory TaskRow.fromJson(
    ...
    return TaskRow(
      ...
      statusBeforeTrash: serializer.fromJson<String?>(
        json['statusBeforeTrash'],
      ),
  ...
  Map<String, dynamic> toJson({ValueSerializer? serializer}) {
    ...
    return <String, dynamic>{
      ...
      'statusBeforeTrash': serializer.toJson<String?>(statusBeforeTrash),
  ...
  TaskRow copyWith({
    ...
    String? notes,
    String? status,
    Value<String?> statusBeforeTrash = const Value.absent(),
    DateTime? createdAt,
    DateTime? updatedAt,
...
class TasksCompanion extends UpdateCompanion<TaskRow> {
  ...
  final Value<String?> statusBeforeTrash;
  ...
  static Insertable<TaskRow> custom({
    ...
    Expression<String>? statusBeforeTrash,
  ...
  TasksCompanion copyWith({
    ...
    Value<String>? notes,
    Value<String>? status,
    Value<String?>? statusBeforeTrash,
  ...
  Map<String, Expression> toColumns(bool nullToAbsent) {
    ...
    if (statusBeforeTrash.present) {
      map['status_before_trash'] = Variable<String>(statusBeforeTrash.value);
    }
...
class SubtaskRow extends DataClass implements Insertable<SubtaskRow> {
  ...
  @override
  int get hashCode =>
      Object.hash(id, taskId, description, isCompleted, position);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is SubtaskRow &&
...
final class $$GroupsTableReferences
  ...
  static MultiTypedResultKey<$TaskListsTable, List<TaskListRow>>
  _taskListsRefsTable(_$AppDatabase db) => MultiTypedResultKey.fromTable(
    db.taskLists,
    aliasName: 'groups__id__task_lists__group_id',
  );
                  ...
                  if (taskListsRefs)
                    ...
                    >(
                      ...
                      managerFromTypedResult: (p0) =>
                          $$GroupsTableReferences(db, table, p0).taskListsRefs,
...
final class $$TaskListsTableReferences
  ...
  static $GroupsTable _groupIdTable(_$AppDatabase db) =>
      db.groups.createAlias('task_lists__group_id__groups__id');
...
class $$TasksTableFilterComposer extends Composer<_$AppDatabase, $TasksTable> {
  ...
  ColumnFilters<String> get statusBeforeTrash => $composableBuilder(
...
class $$TasksTableOrderingComposer
  ...
  ColumnOrderings<String> get statusBeforeTrash => $composableBuilder(
    column: $table.statusBeforeTrash,
    builder: (column) => ColumnOrderings(column),
  );
...
class $$TasksTableAnnotationComposer
  ...
  GeneratedColumn<String> get statusBeforeTrash => $composableBuilder(
    column: $table.statusBeforeTrash,
